...
class GuardStats:
    ...
    total_checks: int = 0
    blocked: int = 0
    threat_counts: dict[str, int] = field(default_factory=lambda: defaultdict(int))
    ...
    def summary(self) -> dict:
        avg_latency = self.total_latency_ms / self.total_checks if self.total_checks > 0 else 0.0
        return {
